        ...
        >
          ...
          <div className="flex flex-1 items-center justify-between">
            <Link
              ...
              aria-label="asilbek dev — Home"
            >
              <span className="h-10 w-10 rounded-full overflow-hidden inline-block shrink-0">
                <img
              ...
              <span className="text-xl font-bold text-gray-900 dark:text-white">
                asilbek <span className="text-primary-600"> dev</span>
              ...
              >
                ...
                <div className="flex items-center justify-between px-5 py-4 border-b border-gray-100 dark:border-gray-800 shrink-0">
                  <Link
                    ...
                    aria-label="asilbek dev — Home"
                  >
                    <span className="h-9 w-9 rounded-full overflow-hidden inline-block shrink-0">
                      <img
                        src="/images/logos/asilbek.png"
                        alt=""
                        aria-hidden="true"
