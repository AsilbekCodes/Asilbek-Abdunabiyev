...
const SITE_URL     = 'https://asilbekdev.uz';
const SITE_NAME    = 'asilbekdev.uz';
const TWITTER      = '@asilbekdev';
...
const PERSON_SCHEMA = {
  ...
  sameAs: [
    'https://github.com/AsilbekCodes',
    'https://www.linkedin.com/in/asilbek-abdunabiyev-0064a436a/',
    'https://t.me/Dasturchim',
    'https://instagram.com/asilbekdev',
  ],
};
...
const WEBSITE_SCHEMA = {
  ...
  url: SITE_URL,
  name: SITE_NAME,
  description: 'Portfolio of Asilbek Abdunabiyev — Full-Stack Developer',
...
const SEO: React.FC<SEOProps> = ({
  ...
  // Full canonical URL including language prefix (e.g. https://asilbekdev.uz/uz/portfolio)
  ...
  const metaDesc = description
    || t('seo.home.description', 'Portfolio of Asilbek Abdunabiyev, a Full-Stack Developer specializing in Laravel, React, and scalable web applications.');
  ...
  return (
    <Helmet>
      ...
      <meta name="author" content="Asilbek Abdunabiyev" />
